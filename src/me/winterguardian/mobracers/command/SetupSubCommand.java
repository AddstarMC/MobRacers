...
public class SetupSubCommand extends SubCommand
{
	...
	{
		super("setup", Arrays.asList("settings", "option", "options", "réglages", "reglages", "paramètres", "parametres", "config", "configuration"), MobRacersPlugin.ADMIN, CourseMessage.COMMAND_INVALID_PERMISSION.toString(),  ChatColor.RED.toString()+ CourseMessage.COMMAND_USAGE + ": "+ChatColor.WHITE.toString()+"/mobracers setup");
		this.game = game;
	}
