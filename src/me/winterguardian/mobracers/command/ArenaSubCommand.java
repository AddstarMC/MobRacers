...
public class ArenaSubCommand extends SubCommand
{
	...
	{
		super("arena", Arrays.asList("arene", "arène", "mapconfig"), MobRacersPlugin.STAFF, CourseMessage.COMMAND_INVALID_PERMISSION.toString(), ChatColor.RED.toString() + CourseMessage.COMMAND_USAGE + ": "+ChatColor.WHITE.toString()+"/mobracers arena help");
	}
