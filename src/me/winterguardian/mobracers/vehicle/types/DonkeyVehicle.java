...
public class DonkeyVehicle extends WinnableVehicle
{
	...
	public Item getItem(ItemType type)
	{
		...
		case WALL:
			return new WallItem(Arrays.asList(new WallBlock(Material.HAY_BLOCK, (byte)0), new WallBlock(Material.HAY_BLOCK, (byte)4), new WallBlock(Material.HAY_BLOCK, (byte)8), new WallBlock(Material.WOOD, (byte)1)), new SoundEffect(Sound.ENTITY_DONKEY_AMBIENT, 1, 1f));
		case SPECIAL:
