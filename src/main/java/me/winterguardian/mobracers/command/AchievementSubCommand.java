...
public class AchievementSubCommand extends SubCommand
{
	...
	{
		super("achievement", Arrays.asList("succès", "success"), null, null, ChatColor.RED.toString()+ CourseMessage.COMMAND_USAGE + ": "+ChatColor.WHITE.toString()+"/mobracers achievement [done]");
	}
