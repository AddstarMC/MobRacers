...
public class UndeadHorseVehicle extends PurchasableVehicle
{
	...
	{
		return new VehicleGUIItem(getType(), 29, Material.MONSTER_EGG, 1, (short)54, ChatColor.DARK_GREEN.toString()+ ChatColor.BOLD.toString()  + getName(), new ArrayList<String>());
	}
}
